...
## 2024-05-24 - Topic Selection
**Topic:** CTCSS / DCS / NAC Filtering
**Learning:** The "CTCSS / DCS / NAC Filtering" feature was listed in the "What's New" section but lacked a dedicated Markdown guide. Added a new guide covering the logic behind filtering out unwanted interference, and added a signal flow Mermaid diagram to clarify interactions.
**Action:** Created `src/main/resources/docs/ctcss-dcs-nac-filtering.md` and integrated it into the navigation tree of `HelpViewController.java` under "Advanced & System".
