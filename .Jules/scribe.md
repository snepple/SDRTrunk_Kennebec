...
**Topic:** CTCSS/DCS Filtering
**Learning:** The application supports advanced CTCSS and DCS tone filtering for analog NBFM channels, but lacked a dedicated "How-To" guide explaining the configuration and signal flow.
**Action:** Created `src/main/resources/docs/ctcss-dcs-filtering.md` with a visual signal flow and integrated it into the navigation tree of `HelpViewController.java` under "Advanced & System".
