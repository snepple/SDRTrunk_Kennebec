...
## 2024-05-15 - Cleanup root directory text, diff and patch artifacts
**Finding:** Many `.patch`, `.diff`, `.txt`, `.py`, `.ps1` and `.md` artifacts leftover from previous AI plans and changes in the root.
**Action:** Removed root level artifacts safely while protecting `src/main/resources/docs`.
