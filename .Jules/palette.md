...
## 2026-05-20 - [UserPreferencesEditor OK Button Accessibility]
**Learning:** The main OK button in the User Preferences Editor lacked a keyboard mnemonic and an informative tooltip, which reduces accessibility and clarity.
**Action:** Ensure all primary dialog action buttons, even simple ones like OK, have a keyboard mnemonic (e.g., '_Ok') and a tooltip explaining their specific function (e.g., closing the window).
