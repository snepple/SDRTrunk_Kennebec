...
## 2026-05-20 - Adding Tooltips to Audio Output Device Editor
**Learning:** Legacy UI controls for audio configurations often lack tooltips, making it ambiguous what each setting (Device, Recordable, Priority) does. This violates the HIG Clarity rule and creates unnecessary cognitive load.
**Action:** Always add `Tooltip` objects programmatically to UI controls for technical preferences to provide immediate, context-specific explanations.
