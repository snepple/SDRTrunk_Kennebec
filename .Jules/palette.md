...
## 2026-05-19 - Adding Tooltips to General Test and Action Buttons
**Learning:** Action buttons (like "Test", "Add", "Remove") in configuration panels (e.g., `AIPreferenceEditor.java` and `NotificationPreferenceEditor.java`) that lack textual context or explanation for their underlying behaviors cause user friction and fail accessibility checks.
**Action:** Always verify if action buttons in JavaFX preference editors lack tooltips and add descriptive `Tooltip` objects explaining their specific functionality (e.g., "Test the provided Gemini API key...") to improve context and accessibility.
...
## 2026-05-23 - Adding Tooltips to Enable Checkboxes in Notification Preferences
**Learning:** General global toggle checkboxes (like "Enable Email" or "Enable Telegram") without additional context or descriptive text can be ambiguous, especially when grouped with specific configuration inputs like host names or tokens.
**Action:** Always verify if global toggle checkboxes have a clear  that provides context about the feature they are enabling or disabling to improve accessibility and user clarity.
## 2026-05-23 - Adding Tooltips to Enable Checkboxes in Notification Preferences
**Learning:** General global toggle checkboxes (like "Enable Email" or "Enable Telegram") without additional context or descriptive text can be ambiguous, especially when grouped with specific configuration inputs like host names or tokens.
**Action:** Always verify if global toggle checkboxes have a clear `Tooltip` that provides context about the feature they are enabling or disabling to improve accessibility and user clarity.
