...
## 2026-06-03 - [Settings Format Standardization]
...
## 2026-06-03 - Adding Tooltips to JMBE Action Buttons
...
## 2026-06-03 - Tooltips for Windows Host Optimization Actions
**Learning:** Action buttons for system-level operations (like checking or applying Windows host settings) can cause hesitation if their precise effects aren't clear.
**Action:** Always add descriptive `Tooltip`s to system-level action buttons in configuration panels to reduce cognitive load and provide upfront clarity about the changes being performed.
