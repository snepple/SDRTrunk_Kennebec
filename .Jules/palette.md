...
## 2026-05-21 - Adding Tooltips and Accessibility to Map Action Buttons
**Learning:** Destructive actions on map interfaces (like clearing or deleting tracks) require explicit warnings in their tooltips to prevent accidental data loss. Furthermore, buttons like 'Follow' need descriptive Accessible Contexts to be properly understood by screen readers, aligning with HIG principles of Feedback and Clarity.
**Action:** Ensure all map interaction and management buttons have comprehensive tooltips (explaining destructive consequences if applicable) and AccessibleContext configurations.
