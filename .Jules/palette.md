...
## 2024-06-25 - Adding Tooltips to Action Buttons in Alias Editors
**Learning:** Action buttons like "Test" and "Select ..." in alias action editors (e.g., BeepEditor, ClipEditor, ScriptEditor) lack descriptive tooltips, resulting in ambiguous interactions that violate HIG's Clarity and Feedback rules.
**Action:** Always add descriptive `Tooltip` objects to action buttons in alias configuration editors to explain their specific functionality and improve context and accessibility.
