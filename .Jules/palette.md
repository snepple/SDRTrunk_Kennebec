...
## 2026-06-06 - [Settings Format Standardization]
...
## 2026-06-06 - Adding Tooltips to JMBE Action Buttons
...
## 2026-06-06 - Adding Tooltips to MapPanel Action Buttons
**Learning:** Action buttons in JavaFX panels (like `MapPanel.java`) that lack textual context or explanation for their underlying behaviors cause user friction and fail accessibility checks.
**Action:** Always verify if action buttons in JavaFX panels lack tooltips and add descriptive `Tooltip` objects explaining their specific functionality. Additionally, apply keyboard mnemonics and fully set the accessible text and help properties. For destructive actions (e.g. Delete, Delete All), include a warning that the action cannot be undone.
