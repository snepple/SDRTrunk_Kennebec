...
* **🚀 New Features**
  * **Enhanced Gain Advisor:** The Gain Advisor now includes Signal-to-Noise Ratio (SNR) estimates and richer context to provide more accurate tuning recommendations.
* **🎨 UI/UX Improvements**
  * **Jargon Tooltips:** Added beginner-friendly tooltips and "Jargon Bridge" explanations for common SDR terms (like LNA, WACN, NAC, PPM, and FFT Size) to help new users easily understand complex settings.
  * **Streamlined Channel Table:** Improved the layout of the Channel metadata table by removing the redundant Activity column and widening the Channel column for better readability.
* **📖 Documentation**
  * **New Feature Guides:** Added three new comprehensive feature guides to the in-app knowledge base.
