...
<CardGroup cols={2}>
  <Card title="Add talkgroup aliases" icon="tag" href="/docs/decoding/aliases-talkgroups">
    Assign names to talkgroup IDs so calls are labelled with recognizable names instead of raw numbers.
  </Card>
  <Card title="Set up streaming" icon="broadcast" href="/docs/streaming/broadcastify">
    Route live audio to Broadcastify, Zello, Icecast, or IamResponding.
  </Card>
  <Card title="Configure alerts" icon="bell" href="/docs/alerts/notifications">
    Receive Telegram or Email notifications for tuner errors and channel inactivity.
  </Card>
  <Card title="Explore hardware options" icon="cpu" href="/docs/hardware/supported-tuners">
