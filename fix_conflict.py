...
with open("src/main/java/io/github/dsheirer/module/decode/nbfm/ai/AIAudioOptimizer.java", "r") as f:
    content = f.read()

# I will just write the file completely from scratch to avoid any issues

resolved_file = """package io.github.dsheirer.module.decode.nbfm.ai;
...
with open("src/main/java/io/github/dsheirer/module/decode/nbfm/ai/AIAudioOptimizer.java", "w") as f:
