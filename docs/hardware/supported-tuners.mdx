---
title: "Supported SDR Tuners and Hardware in SDRTrunk Kennebec"
description: "Every SDR tuner compatible with SDRTrunk Kennebec, with chip identifiers, connection types, TunerType enum values, and tuner status definitions."
sidebarTitle: "Supported Tuners"
---
...
<CardGroup cols={2}>
  <Card title="RTL-SDR" icon="usb" href="/docs/hardware/rtl-sdr">
    Driver setup, sample rate, gain, and PPM correction for RTL2832-based dongles on Windows, Linux, and macOS.
  </Card>
  <Card title="Airspy & HackRF" icon="radio" href="/docs/hardware/airspy-hackrf">
    Driver installation and configuration options for Airspy Mini/R2, Airspy HF+, and all HackRF variants.
  </Card>
  <Card title="Tuner Self-Healing" icon="rotate" href="/docs/hardware/tuner-self-healing">
