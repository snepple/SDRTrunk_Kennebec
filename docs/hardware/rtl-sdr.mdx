---
title: "Connect and Configure an RTL-SDR Tuner in SDRTrunk Kennebec"
description: "Install the correct driver for your RTL2832 dongle, then set sample rate, LNA gain, mixer gain, PPM correction, and Bias-T from the tuner editor."
sidebarTitle: "RTL-SDR"
---
...
<Tabs>
  <Tab title="Windows">
    ...
    <Steps>
      ...
      <Step title="Select your RTL-SDR device">
      ...
      <Step title="Install the WinUSB driver">
      ...
      <Step title="Reconnect and launch">
  ...
  <Tab title="Linux">
    ...
    <Steps>
      <Step title="Blacklist the DVB kernel module">
      ...
      <Step title="Reload the module or reboot">
      ...
      <Step title="Launch SDRTrunk Kennebec">
