---
title: "Organize talkgroups and radio IDs with aliases"
description: "Assign human-readable names, colors, icons, and automated actions to talkgroup and radio IDs using aliases in the SDRTrunk Kennebec Playlist Editor."
...
<Steps>
  <Step title="Open the Alias Editor">
    Click **Aliases** in the **Playlist Editor** sidebar.
  </Step>
  <Step title="Add a new alias list">
...
<Steps>
  ...
  <Step title="Set a color (optional)">
...
<Steps>
  ...
  <Step title="Browse to your system">
