---
title: "Decode DMR conventional and trunked radio channels"
description: "Set up DMR Tier I, Tier II, and Tier III channels in SDRTrunk Kennebec with talkgroup aliases, color codes, timeslot decoding, and CRC error handling options."
sidebarTitle: "DMR"
---
...
<Steps>
  ...
  <Step title="Configure decoder options">
...
<Steps>
  ...
  <Step title="Add a talkgroup alias">
...
<AccordionGroup>
  <Accordion title="Timeslot 2 shows no activity on a Tier III system">
  ...
  <Accordion title="Talkgroup IDs do not match RadioReference listings">
  ...
  <Accordion title="Decoding works but audio quality is poor">
  ...
  <Accordion title="CRC errors in the log and calls cutting out">
