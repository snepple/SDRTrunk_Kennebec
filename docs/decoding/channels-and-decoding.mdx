...
<CardGroup cols={2}>
  <Card title="P25 Phase 1 & Phase 2" icon="radio" href="/decoding/p25">
  ...
  <Card title="DMR" icon="signal" href="/decoding/dmr">
  ...
  <Card title="NBFM & AM" icon="wave-square" href="/decoding/analog">
