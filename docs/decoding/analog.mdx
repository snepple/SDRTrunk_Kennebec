---
title: "Decode analog radio: NBFM, AM, and tone squelch"
description: "Monitor narrowband FM and AM channels with configurable squelch, CTCSS and DCS tone filtering, post-demodulation audio filters, and MDC-1200 metadata decoding."
sidebarTitle: "Analog"
---
...
<Steps>
  ...
  <Step title="Select the channel bandwidth">
  ...
  <Step title="Configure audio filters (optional)">
...
<Steps>
  ...
  <Step title="Add a DCS tone filter">
