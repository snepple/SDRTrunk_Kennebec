---
title: "What is SDRTrunk Kennebec?"
description: "SDRTrunk Kennebec turns compatible SDR hardware into a multi-channel trunked radio scanner with live streaming, automated alerts, and optional AI monitoring."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Hardware setup" icon="cpu" href="/docs/hardware/supported-tuners">
    Connect and configure your RTL-SDR, Airspy, HackRF, or SDRPlay tuner.
  </Card>
  <Card title="Channels and decoding" icon="radio" href="/docs/decoding/channels-and-decoding">
    Understand how to configure P25, DMR, and analog channels.
  </Card>
  <Card title="Streaming" icon="broadcast" href="/docs/streaming/broadcastify">
