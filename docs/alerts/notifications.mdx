---
title: "Set Up Telegram and Email Error Notifications"
description: "Send yourself real-time alerts via Telegram or Email when a tuner fails or a critical application error occurs, without keeping SDRTrunk Kennebec in focus."
...
<Steps>
  ...
  <Step title="Enter your credentials in SDRTrunk Kennebec">
...
<AccordionGroup>
  <Accordion title="No Telegram message received">
  ...
  <Accordion title="Email delivery fails">
  ...
  <Accordion title="Notifications fire too frequently">
