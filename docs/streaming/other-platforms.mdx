---
title: "Stream to Icecast, Shoutcast, and IAmResponding"
description: "Stream live audio to Icecast and Shoutcast servers, send UDP audio to IAmResponding for Two Tone Detect dispatch alerting, or route audio via virtual cable."
...
<Steps>
  <Step title="Confirm IAmResponding is running">
