---
title: "Stream Decoded Radio Audio to Zello Channels"
description: "Bridge decoded radio audio into Zello Work or Zello Consumer channels in real time using SDRTrunk Kennebec's WebSocket-based push-to-talk integration."
sidebarTitle: "Zello"
---
...
<Steps>
  ...
  <Step title="Add a Zello Work broadcaster">
  ...
  <Step title="Configure timing parameters (optional)">
...
<Steps>
  <Step title="Obtain a Zello developer auth token">
  ...
  <Step title="Add a Zello Consumer broadcaster">
