---
title: "Upload Trunked Call Recordings to ThinLine Radio"
description: "Upload completed MP3 call recordings and metadata to ThinLine Radio's call archive API, with built-in connection testing and default diagnostic logging."
sidebarTitle: "ThinLine Radio"
---
...
<Steps>
  ...
  <Step title="Add a ThinLine Radio broadcaster">
