---
title: "Upload Trunked Call Recordings to Rdio Scanner"
description: "Configure SDRTrunk Kennebec to post completed MP3 call recordings with full metadata to a self-hosted Rdio Scanner web application via its HTTP API."
sidebarTitle: "Rdio Scanner"
---
...
<Steps>
  ...
  <Step title="Add an Rdio Scanner broadcaster">
