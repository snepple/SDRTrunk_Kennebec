---
title: "Enable Diagnostics and Debug Logging in SDRTrunk"
description: "Toggle per-subsystem DEBUG logging at runtime from the Diagnostics panel without restarting the application, and learn when to use each category."
...
<Steps>
  <Step title="Enable the relevant category">
  ...
  <Step title="Attach to your report">
