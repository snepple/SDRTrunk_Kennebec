---
title: "Browse, Filter, and Play Back Audio Recordings"
description: "Use the Audio Recordings panel to browse, filter, and play back recorded calls, set the recording directory, and enable recording on individual aliases."
sidebarTitle: "Audio Recordings"
---
...
<Steps>
  ...
  <Step title="Select the alias to record">
...
<Steps>
  ...
  <Step title="Navigate to Directory settings">
    In the preferences panel, select **File Storage → Directories**.
  </Step>
  <Step title="Set the recording path">
