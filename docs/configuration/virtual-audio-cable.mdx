---
title: "Route Decoded Audio to External Apps via Virtual Cable"
description: "Route decoded audio from specific aliases to virtual audio devices, enabling OBS streaming, speech transcription, paging detection, and secondary recording."
sidebarTitle: "Virtual Audio Cable"
---
