...
The application defaults to 6 GB of allocated memory. You can adjust this limit directly from the user preferences interface without editing configuration files.
