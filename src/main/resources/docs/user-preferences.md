# Configure SDRTrunk Kennebec with User Preferences
...
**Diagnostics (Logging)** — Runtime per-category DEBUG log toggles. See [Enable diagnostics and debug logging](/docs/configuration/diagnostics) for full details.

**MQTT** — Publish radio events to an MQTT broker for home automation or monitoring. See [Connect SDRTrunk Kennebec to an MQTT broker](/docs/configuration/mqtt) for full details.
