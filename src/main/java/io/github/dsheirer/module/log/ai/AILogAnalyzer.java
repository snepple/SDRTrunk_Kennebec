...
public class AILogAnalyzer {
    ...
    public String analyze(String logContent) throws Exception {
        ...
        try {
            ...
            String promptText = "Analyze this log file. Translate cryptic stack traces and warning logs into plain-English explanations with actionable fixes. Output the review directly as if it was generated by the SDRTrunk system without any conversational introductions:\\n\\n" + escapedLogContent;
