...
public class TunerPreferenceEditor extends VBox
{
    ...
    public TunerPreferenceEditor(UserPreferences userPreferences)
    {
        ...
        SettingsRow channelizerRow = new SettingsRow((javafx.scene.Node)null, getChannelizerTypeChoiceBox());
        ...
        SettingsRow rspDuoRow = new SettingsRow((javafx.scene.Node)null, getRspDuoTunerModeChoiceBox());
