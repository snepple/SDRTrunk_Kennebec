...
/**
 * ThinLine Radio calls API configuration editor
 */
public class ThinLineRadioEditor extends AbstractBroadcastEditor<ThinLineRadioConfiguration>
{
    private final static Logger mLog = LoggerFactory.getLogger(ThinLineRadioEditor.class);
     ...
     */
    public ThinLineRadioEditor(PlaylistManager playlistManager)
    {
        super(playlistManager);
    }

    @Override
    public void setItem(ThinLineRadioConfiguration item)
    {
        super.setItem(item);
    ...
    {
        return BroadcastServerType.THINLINE_RADIO;
    }
    ...
    protected GridPane getEditorPane()
    {
        if(mEditorPane == null)
        {
            ...
            Label hostLabel = new Label("ThinLine Radio URL");
