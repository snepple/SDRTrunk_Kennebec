...
public class TetraConfigurationEditor extends ChannelConfigurationEditor {
    ...
    public TetraConfigurationEditor(PlaylistManager playlistManager, TunerManager tunerManager, UserPreferences userPreferences, IFilterProcessor filterProcessor) {
        super(playlistManager, tunerManager, userPreferences, filterProcessor);
    }

    @Override
    public DecoderType getDecoderType() { return DecoderType.TETRA; }
