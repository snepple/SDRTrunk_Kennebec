        ...
        if(mDecoderPane == null)
        {
            ...
            scrambleCard.getChildren().addAll(
                new SettingsRow("WACN",
                    createHelpIcon("<html><b>WACN (Wide Area Communication Network):</b> A unique code identifying a large regional radio system.<br>This is usually provided by RadioReference and tells the software which network to follow.</html>"),
                    getWacnTextField()),
