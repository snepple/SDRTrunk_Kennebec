...
public class NxdnConfigurationEditor extends ChannelConfigurationEditor {
    ...
    public NxdnConfigurationEditor(PlaylistManager playlistManager, TunerManager tunerManager, UserPreferences userPreferences, IFilterProcessor filterProcessor) {
        super(playlistManager, tunerManager, userPreferences, filterProcessor);
    }

    @Override
    public DecoderType getDecoderType() { return DecoderType.NXDN; }
