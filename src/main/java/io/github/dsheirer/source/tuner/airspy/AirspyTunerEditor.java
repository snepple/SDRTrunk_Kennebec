...
public class AirspyTunerEditor extends TunerEditor<AirspyTuner, AirspyTunerConfiguration>
{
    ...
    protected void tunerStatusUpdated()
    {
        ...
        if(hasTuner())
        {
            ...
            getSampleRateCombo().setItems(FXCollections.observableArrayList(rates.toArray(new AirspySampleRate[rates.size()])));
    ...
    private Slider getLNAGainSlider()
    {
        ...
        {
            mLNAGainSlider = new Slider(AirspyTunerController.LNA_GAIN_MIN,
    ...
    private Slider getMixerGainSlider()
    {
        ...
        {
            mMixerGainSlider = new Slider(AirspyTunerController.MIXER_GAIN_MIN,
    ...
    private Slider getIFGainSlider()
    {
        ...
        {
            mIFGainSlider = new Slider(AirspyTunerController.IF_GAIN_MIN,
    ...
    private Slider getMasterGainSlider()
    {
        ...
        {
            mMasterGainSlider = new Slider(AirspyTunerController.GAIN_MIN,
...
/**
    ...
    public void save()
    {
        if(hasConfiguration() && !isLoading())
        {
            ...
            getConfiguration().setSampleRate(((AirspySampleRate)getSampleRateCombo().getValue()).getRate());
