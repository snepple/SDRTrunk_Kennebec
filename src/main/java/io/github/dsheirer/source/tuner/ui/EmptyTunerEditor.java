...
public class EmptyTunerEditor extends StackPane
{
    ...
    {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("EmptyTunerEditor.fxml"));
        loader.setRoot(this);
        loader.setController(new EmptyTunerEditorController());
        try {
            loader.load();
        } catch (IOException e) {
            mLog.error("Error loading EmptyTunerEditor.fxml", e);
        }
    }
}
